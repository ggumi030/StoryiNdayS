...
public class QCommentLike extends EntityPathBase<CommentLike> {
    ...
    private static final long serialVersionUID = 1551687982L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QCommentLike commentLike1 = new QCommentLike("commentLike1");

    public final QComment comment;

    public final BooleanPath commentLike = createBoolean("commentLike");
